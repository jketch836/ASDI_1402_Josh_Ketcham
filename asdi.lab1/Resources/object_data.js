//Dot Notations Rurouni Kenshin Manga		
	var battosai = new Object();
		...
		battosai.image = 'pictures/kenshin.png',
		...
		battosai.stats = function (){
			return "Name: " + battosai.name + '\nAlias: '  + battosai.aka + "\nAge: " + battosai.age + "\nRobe Color:  " + battosai.robe + "\nWeapon: " + battosai.weapon;
		};	
	...
	var zanza = new Object();
		...
		zanza.image = 'pictures/zanza.png',		
		zanza.info = function(){
			return zanza.name + "'s weapon is " + zanza.weapon + '. It is a weapon street fighters use';
		};
		...
		zanza.stats = function (){
			return "Name: " + zanza.name + '\nAlias: '  + zanza.aka + "\nAge: " + zanza.age + "\nRobe Color:  " + zanza.robe + "\nWeapon: " + zanza.weapon;
		};			
	...
	var karou = new Object();
		...
		karou.age = 17;
		karou.weapon = "Bokken";
		karou.image = 'pictures/karou.png',		
		karou.info = function(){
		...
		karou.stats = function (){
			return "Name: " + karou.name + '\nAlias: '  + karou.aka + "\nAge: " + karou.age + "\nRobe Color:  " + karou.robe + "\nWeapon: " + karou.weapon;
		};
	...
	var yahiko = new Object();
		...
		yahiko.image = 'pictures/yahiko.png',		
		...
		yahiko.stats = function (){
			return "Name: " + yahiko.name + '\nAlias: '  + yahiko.aka + "\nAge: " + yahiko.age + "\nRobe Color:  " + yahiko.robe + "\nWeapon: " + yahiko.weapon;
		};
	...
	var Shishio = new Object ();
		...
		Shishio.image = 'pictures/shishio.png',		
		Shishio.info = function(){
			return Shishio.name + "'s weapon is a " + Shishio.weapon + ". It is a weapon that samurais used.";
		};
		...
		Shishio.stats = function (){
			return "Name: " + Shishio.name + '\nAlias: '  + Shishio.aka + "\nAge: " + Shishio.age + "\nRobe Color:  " + Shishio.robe + "\nWeapon: " + Shishio.weapon;
		};
